...
import nm_python_softIK.nm_python_softIK_proc as nm_python_softIK_proc
reload (nm_python_softIK_proc)

"""
import nm_python_softIK.nm_python_softIK_UI as nm_python_softIK_UI
...
#-----------------------------------------------------------------------------------------------------------------------------#
	...
	b1 = cmds.button(label = "GO!", w = 205, h = 30, c = partial(nm_python_softIK_proc.softIK_proc) )
