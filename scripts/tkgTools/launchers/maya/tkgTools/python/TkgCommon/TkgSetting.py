...
class TkgSetting(object):
    ...
    def Save(self, key, value):
        ...
        doc = TkgXml.GetDocument(self.filePath)
        ...
        TkgXml.SaveDocument(self.filePath, doc)
    ...
    def Load(self, key, dataType="string"):
        ...
        if doc:
            ...
            if dataNode:
                dataValue = TkgXml.GetAttrValue("Value", dataNode)
    ...
    def __CreateFile(self):
        ...
        if os.path.isfile(self.filePath) is False:
            ...
            TkgXml.CreateDocument(self.filePath, "SettingData")
    ...
    def __GetDataNode(self, rootNode, key):
        ...
        dataNodeList = TkgXml.GetNodeList("", rootNode)

        for node in dataNodeList:

            thisKey = TkgXml.GetAttrValue("Key", node)
