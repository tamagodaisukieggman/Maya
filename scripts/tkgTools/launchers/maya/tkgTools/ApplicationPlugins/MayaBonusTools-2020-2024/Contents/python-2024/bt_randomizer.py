...
#
# Randomizer by Roland Reyer, (c) Autodesk GmbH 2011
#
# this is Version 1.1 (2021/01/26)
#
...
def standardWindow(windowName, title, buttons):
    '''
      This function creates a standard window with a columnLayout and some button below.
    ...
    # if no UI name is given then create a window
    if windowName == '':
        windowName = mc.window(w=414, h=402, title=title)
