...
def bt_addTransparencyAttr():
    ...
    if cmds.ls(sl=True):
        ...
        cmds.inViewMessage(smg="Viewport must be in shaded+textured mode to see Transparency - 6 key to enable.", pos="midCenter", bkc=0x11111111, alpha=".5", fade=1, fst=5000)
