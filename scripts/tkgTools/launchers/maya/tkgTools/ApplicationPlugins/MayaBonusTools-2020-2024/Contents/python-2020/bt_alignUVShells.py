...
def bt_doAlignUVShells( direction ):
	#cmds.window( 'AlignUVShellsWin', title='Align UV Shells', s=0)
...
def bt_alignUVShells():
 
    if cmds.window('AlignUVShellsWin', ex=1) == 1:
        cmds.deleteUI('AlignUVShellsWin', wnd=1)
        #cmds.windowPref ('AlignUVShellsWin', r=1)
     
    if cmds.window('AlignUVShellsWin', ex=1) == 0:
    	window=cmds.window( 'AlignUVShellsWin', title='Align UV Shells', s=0)
