...
class FacialTargetRenderer(object):
    ...
    def render(self, should_output_psd):
        ...
        render.set_base_file_name(title_file_name)
        cmds.currentTime(0)
        render.render()
        ...
        if should_output_psd:
            ...
            template_file_path = server_dir_path + \
                '/sample/gallop/glp_chara_facial_tool/facial_target_template.psd'
    ...
    def render_face_type(self, should_output_psd):
        ...
        if should_output_psd:
            ...
            template_file_path = server_dir_path + \
                '/sample/gallop/glp_chara_facial_tool/face_type_target_template.psd'
