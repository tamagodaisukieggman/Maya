...
class Setting(object):
    ...
    def __initialize(self):
        ...
        if platform.system() == 'Windows':
            temp_dir_path = re.sub('appdata/local/temp', 'documents/maya/scripts', temp_dir_path, flags=re.IGNORECASE)
    ...
    def __set_key_attribute(self, key, value):
        ...
        cmds.setAttr(self.setting_group + '.' + key, convert_value, type='string')
    ...
    def __convert_value_from_string(self, value, value_type, default_value):
        ...
        if value_type == str or value_type is None:
