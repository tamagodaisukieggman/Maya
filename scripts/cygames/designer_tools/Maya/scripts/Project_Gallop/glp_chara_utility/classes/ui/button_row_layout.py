...
class ButtonRowLayout(object):
    ...
    def set_button(self, label, function, *on_function_args, **button_edit_param):
        ...
        button_param = ButtonParam(label, function, on_function_args)
...
class ButtonParam(object):
    ...
    # ===============================================
    def __init__(self, label='', function=None, args=[]):
        """
        """
    ...
    def create(self, **params):
        ...
        self.button = base_class.ui.button.Button(self.label, self.function, *self.args, **params)
