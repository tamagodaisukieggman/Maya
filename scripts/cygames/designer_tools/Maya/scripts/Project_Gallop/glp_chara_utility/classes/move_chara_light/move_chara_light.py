...
class MoveCharaLight(object):
    ...
    def __init__(self):
        ...
        self.tmp_follow_parent_constraint_name = '____charaLightFollowTmp_Constraint'
    ...
    def _reset_light_states(self):
        ...
        if cmds.objExists(self.tmp_follow_parent_constraint_name):
            cmds.delete(self.tmp_follow_parent_constraint_name)
    ...
    def follow_light_to_persp(self):
        ...
        # 追従開始
            ...
            self._reset_light_states()
            cmds.xform(self.chara_light_name, ws=True, a=True, t=self.before_aim_translate)
            cmds.parentConstraint(self.chara_light_rig_aim, self.chara_light_name, mo=True, n=self.tmp_follow_parent_constraint_name)
