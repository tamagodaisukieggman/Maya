    ...
    for root, dirs, files in os.walk(target_dir_path):
        ...
        for file_name in files:
            ...
            if is_pyc:
                ...
                exec_string = 'from {0} import {1};{2}reload({1})'.format(relative_path, file_name_noext, reload_str)
        ...
        for dir_name in dirs:
            ...
            exec_string = 'from {0} import {1};{2}reload({1})'.format(relative_path, dir_name, reload_str)
