...
import TkgOpenWinExplorer
import TkgOpenWebPage
reload(TkgOpenWinExplorer)
reload(TkgOpenWebPage)

toolName = "TkgMultiExporterUI"
...
class MainWindow(object):
    def __init__(self, toolInfo):
        ...
        #ツール設定のパス
        self.configFolderPath = userAppDirPath + "TKG/" + self.toolName
    ...
    #ヘルプを開く
    def helpFunc(self):
        TkgOpenWebPage.open("https://wisdom.tkgpublic.jp/pages/viewpage.action?pageId=25927354")
...
def explorerButton_onClick(self):
    ...
    TkgOpenWinExplorer.open("", inputtedFilePath)
