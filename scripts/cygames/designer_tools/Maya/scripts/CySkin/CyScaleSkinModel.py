...
import CyPivotTool
from CyDagNode import getFilteredDagNodeInfo
...
class MainWindow(object):
    ...
    def scale(self, direction, plus_or_minus):
        ...
        for currentNode in selNodes:
            ...
            allChildNodes = CySelectChildNode.getChildNodes(currentNode, [])
