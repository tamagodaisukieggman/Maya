...
def Initialize(scriptFilePath):
    ...
    if g_defaultSetting == None:
        g_defaultSetting = CySetting(g_toolName,scriptDirPath)
...
class CheckManager:
    ...
    def __init__(self,rootPath=""):
        ...
        self.toolName = "CyDataCheckerBase"
    ...
    def CreateUI(self):
        ...
        cmds.button( label="Check", bgc=(0.8,0.5,0.5) ,w=formWidth, h=40, command="import CyDataCheckerBase;CyDataCheckerBase.ExecuteDirectCheck()")
