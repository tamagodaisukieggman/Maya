...
def selectWithSettings(mainFlg=0):
    if mainFlg == 1:
        ...
        print("#import TkgSelectChildNode;reload(TkgSelectChildNode);TkgSelectChildNode.selectWithSettings()")
        print("#-----")
        print("")
...
def select(filters, selTransformFlg, selShapeFlg, selSrcFlg, mainFlg=0):
    if mainFlg == 1:
        ...
        print("#-----")
        print("#[Python Command]")
        print("#import TkgSelectChildNode;reload(TkgSelectChildNode);TkgSelectChildNode.select(filters=" + str(filters).replace(" ", "") + ", selTransformFlg=" + str(selTransformFlg) + ", selShapeFlg=" + str(selShapeFlg) + ", selSrcFlg=" + str(selSrcFlg) + ")")
        print("#-----")
        print("")
...
def filter(filters, selTransformFlg, selShapeFlg, mainFlg=0):
    if mainFlg == 1:
        ...
        print("#-----")
        print("#[Python Command]")
        print("#import TkgSelectChildNode;reload(TkgSelectChildNode);TkgSelectChildNode.filter(filters=" + str(filters).replace(" ", "") + ", selTransformFlg=" + str(selTransformFlg) + ", selShapeFlg=" + str(selShapeFlg) + ")")
        print("#-----")
        print("")
