...
g_version = "1.0.0"
g_toolName = "TkgVertexColorLayer"
...
class LayerManager:
    ...
    def __init__(self):
        ...
        self.id = TkgUtility.GetRandomString(15)

        self.flagPrefix = "____"
        self.colorSetPrefix = "TkgVCL_"
    ...
    def RenameColorSet(self, target, srcFullColorSet, dstShortColorSet):
        ...
        if thisId == "":
            thisId = TkgUtility.GetRandomString(5)
...
class Layer:
    ...
    def CreateColorSet(self, target, name, priority):
        ...
        newFullColorSet = self.GetShortColorSet("") + self.manager.flagPrefix + "id_" + TkgUtility.GetRandomString(5)
