...
g_version = "0.1.0"
g_toolName = "TkgVertexPositionEditor"
...
class VertexPositionManager(object):
    ...
    def PastePositionByIndex(self):
        ...
        TkgUtility.StartProgress("Paste Position By Index")
    ...
    def PastePositionBySelectOrder(self):
        ...
        TkgUtility.StartProgress("Paste Position By SelectOrder")
    ...
    def PastePositionByPosition(self):
        ...
        TkgUtility.StartProgress("Pasete Position By Position")
    ...
    def PastePositionByMirror(self, isX, isY, isZ):
        ...
        TkgUtility.StartProgress("Paste Position By Mirror")
...
class VertexInfo(object):
    ...
    def RewriteData(self, targetVtxInfo):
        ...
        self.position = TkgUtility.CopyList(targetVtxInfo.position)
