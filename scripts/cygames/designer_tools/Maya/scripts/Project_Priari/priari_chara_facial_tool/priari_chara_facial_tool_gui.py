...
from . import priari_chara_facial_tool_pyside2
...
class GUI(mayaMixin.MayaQWidgetBaseMixin, QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.GEO_OPTION_VAR = 'PriariCharaFacialToolGeoVar'

        self.titleName = 'PriariCharaFacialTool'
        self.ui = priari_chara_facial_tool_pyside2.Ui_MainWindow()
