...
def get_vertex_list_with_unround_color(vertex_color_info, digit):
    ...
    for info_item in vertex_color_info.info_item_list:
        ...
        for vertex_color_info in info_item.vertex_color_info_list:
            ...
            is_round = True
            for value in this_color:
                if not base_utility.value.is_round(value, digit):
                    is_round = False
                    break
...
# ==================================================
def get_vertex_list_with_unshared_color(vertex_color_info, threshold=0.001):
    """
    ...
    for info_item in vertex_color_info.info_item_list:
        ...
        for fix_vertex_color_info in info_item.fix_vertex_color_info_list:
            ...
            for vertex_color_info in fix_vertex_color_info:
                ...
                is_same = True
                count = -1
                for src_value in first_color:
                    count += 1

                    if not base_utility.value.is_same(src_value, this_color[count], threshold):
                        is_same_color = False
                        break
