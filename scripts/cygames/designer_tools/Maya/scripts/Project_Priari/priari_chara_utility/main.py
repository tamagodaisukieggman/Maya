...
class Main(object):
    ...
    def __init__(self):
        ...
        self.window_name = 'PriariCharaUtilityNew'
    ...
    def show_ui(self):
        ...
        self.main_window_class = base_class.ui.window.Window(
            self.window_name, 'Priari Chara Utility ver {}'.format(self.tool_version), menu_list=self.menu_list,
...
class SettingShelfWindow(object):
    ...
    def __init__(self, main):
        ...
        self.main = main
        self.setting_shelf_window_name = 'PriariCharaUtilitySettingShelf'
        self.shelf_window_class = None
...
class SortClassWindow(object):
    ...
    def __init__(self, main):
        ...
        self.main = main
        self.sort_class_window_name = 'PriariCharaUtilitySortClass'
        self.sort_class_window_class = None
