...
from ....priari_common.classes.info import facial_info
from ....priari_common.classes.info import general_data_info
...
class Main(main_template.Main):
    ...
    def __init__(self):
        ...
        self.tool_name = 'PriariCharaUtilityTextureChanger'
