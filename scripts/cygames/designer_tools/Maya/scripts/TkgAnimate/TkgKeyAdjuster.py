...
#ツール設定のパス
g_configFolderPath = g_userAppDirPath + "TKG/" + g_toolName
...
class MainWindow(object):
    def __init__(self):
        ...
        #ウィンドウ
        self.window = pm.window(g_toolName, title=u"TkgKeyAdjuster", minimizeButton=0, maximizeButton=0, sizeable=1)
        with self.window:
            with pm.columnLayout(columnOffset=("left", 5)):
                ...
                with pm.frameLayout(bgc=[0.3,0.1,0.0], w=frameLayoutWidthValue, borderVisible=frameLayoutBorderVisibleValue, marginHeight=5, labelVisible=1, font="plainLabelFont", label=u"■ 選択キーの移動"):
                    with pm.columnLayout(rowSpacing=3, columnOffset=("left", 14)):
                        ...
                        with pm.rowLayout(numberOfColumns=4):
                            ...
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを時-方向に相対移動", image1="TkgKeyAdjuster/TkgKeyAdjuster_moveTimeMinus.bmp", w=26, h=26, command=pm.Callback(self.transform, "move", "time", "minus"))
                            ...
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを時+方向に相対移動", image1="TkgKeyAdjuster/TkgKeyAdjuster_moveTimePlus.bmp", w=26, h=26, command=pm.Callback(self.transform, "move", "time", "plus"))

                        #移動(値)
                        with pm.rowLayout(numberOfColumns=4):
                            pm.text(align="left", label=u"値 : ")
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを値-方向に相対移動", image1="TkgKeyAdjuster/TkgKeyAdjuster_moveValueMinus.bmp", w=26, h=26, command=pm.Callback(self.transform, "move", "value", "minus"))
                            ...
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを値+方向に相対移動", image1="TkgKeyAdjuster/TkgKeyAdjuster_moveValuePlus.bmp", w=26, h=26, command=pm.Callback(self.transform, "move", "value", "plus"))
                ...
                with pm.frameLayout(bgc=[0.2,0.3,0.1], w=frameLayoutWidthValue, borderVisible=frameLayoutBorderVisibleValue, marginHeight=5, labelVisible=1, font="plainLabelFont", label=u"■ 選択キーのスケール"):
                    with pm.columnLayout(rowSpacing=3, columnOffset=("left", 14)):
                        ...
                        with pm.rowLayout(numberOfColumns=4):
                            pm.text(align="left", label=u"時 : ")
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを「時」方向に縮小 ※Pivot位置を使用", image1="TkgKeyAdjuster/TkgKeyAdjuster_scaleTimeDiv.bmp", w=26, h=26, command=pm.Callback(self.transform, "scale", "time", "div"))
                            ...
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを「時」方向に拡大 ※Pivot位置を使用", image1="TkgKeyAdjuster/TkgKeyAdjuster_scaleTimeMlt.bmp", w=26, h=26, command=pm.Callback(self.transform, "scale", "time", "mlt"))

                        #スケール(値)
                        with pm.rowLayout(numberOfColumns=4):
                            pm.text(align="left", label=u"値 : ")
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを「値」方向に縮小 ※Pivot位置を使用", image1="TkgKeyAdjuster/TkgKeyAdjuster_scaleValueDiv.bmp", w=26, h=26, command=pm.Callback(self.transform, "scale", "value", "div"))
                            ...
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを「値」方向に拡大 ※Pivot位置を使用", image1="TkgKeyAdjuster/TkgKeyAdjuster_scaleValueMlt.bmp", w=26, h=26, command=pm.Callback(self.transform, "scale", "value", "mlt"))
                ...
                with pm.frameLayout(bgc=[0.1,0.2,0.3], w=frameLayoutWidthValue, borderVisible=frameLayoutBorderVisibleValue, marginHeight=5, labelVisible=1, font="plainLabelFont", label=u"■ 選択キーの整列"):
                    with pm.columnLayout(rowSpacing=3, columnOffset=("left", 14)):
                        ...
                        with pm.rowLayout(numberOfColumns=4):
                            pm.text(align="left", label=u"時 :")
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを「時」の最小値に整列", image1="TkgKeyAdjuster/TkgKeyAdjuster_alignTimeMin.bmp", w=40, h=26, command=pm.Callback(self.transform, "align", "time", "min"))
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを「時」の中間値に整列", image1="TkgKeyAdjuster/TkgKeyAdjuster_alignTimeCen.bmp", w=40, h=26, command=pm.Callback(self.transform, "align", "time", "cen"))
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを「時」の最大値に整列", image1="TkgKeyAdjuster/TkgKeyAdjuster_alignTimeMax.bmp", w=40, h=26, command=pm.Callback(self.transform, "align", "time", "max"))

                        #整列・値
                        with pm.rowLayout(numberOfColumns=4):
                            pm.text(align="left", label=u"値 :")
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを「値」の最小値に整列", image1="TkgKeyAdjuster/TkgKeyAdjuster_alignValueMin.bmp", w=40, h=26, command=pm.Callback(self.transform, "align", "value", "min"))
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを「値」の中間値に整列", image1="TkgKeyAdjuster/TkgKeyAdjuster_alignValueCen.bmp", w=40, h=26, command=pm.Callback(self.transform, "align", "value", "cen"))
                            pm.iconTextButton(style="iconOnly", annotation=u"選択キーを「値」の最大値に整列", image1="TkgKeyAdjuster/TkgKeyAdjuster_alignValueMax.bmp", w=40, h=26, command=pm.Callback(self.transform, "align", "value", "max"))
