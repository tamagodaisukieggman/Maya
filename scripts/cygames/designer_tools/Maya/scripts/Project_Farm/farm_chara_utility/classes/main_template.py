...
class Main(object):
    ...
    def __init__(self, class_name=''):
        ...
        if sys.version_info.major == 2:
            self.this_base_common_reload_str = 'import Project_Farm.base_common;reload(Project_Farm.base_common);'
        else:
            self.this_base_common_reload_str = 'import Project_Farm.base_common;from importlib import reload;reload(Project_Farm.base_common);'
        if sys.version_info.major == 2:
            self.this_farm_common_reload_str = 'import Project_Farm.farm_common;reload(Project_Farm.farm_common);'
        else:
            self.this_farm_common_reload_str = 'import Project_Farm.farm_common;from importlib import reload;reload(Project_Farm.farm_common);'
        ...
        if class_name:
            self.this_class_str = 'Project_Farm.farm_chara_utility.classes.{}'.format(class_name)
        ...
        self.setting_tool_name = 'FarmCharaUtilityNew'
    ...
    def _create_shelf_command_str(self, exec_module_str, exec_func_str, *exec_func_args):
        ...
        shelf_command = '{0}{1}'.format(
            ...
            self.this_farm_common_reload_str
        )
