...
from ....farm_common.utility import model_define as define

from .. import main_template
from . import farm_scene_opener
...
class Main(main_template.Main):
    ...
    def __init__(self):
        ...
        self.tool_name = 'FarmSceneOpener'
        self.tool_label = 'モデルシーンを開く'
        self.tool_version = '22080901'

        self.scene_opener = farm_scene_opener.FarmSceneOpener()
