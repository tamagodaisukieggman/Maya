...
class CheckerParamRoot(object):
    ...
    def on_default_batch_setting(self, this_type):
        ...
        if this_type == 'unit':
            ...
            this_input_dir_path = 'W:/Farm/svn/farm/80_3D/01_character/model/unit'
            this_output_file_path = 'W:/Farm/svn/farm/80_3D/01_character/model/check_unit.csv'
            ...
            this_input_dir_path = 'W:/Farm/svn/farm/80_3D/01_character/model/avatar'
            this_output_file_path = 'W:/Farm/svn/farm/80_3D/01_character/model/check_avatar.csv'
            ...
            this_input_dir_path = 'W:/Farm/svn/farm/80_3D/01_character/model/weapon'
            this_output_file_path = 'W:/Farm/svn/farm/80_3D/01_character/model/check_weapon.csv'
    ...
    def _execute_batch_base(self, should_output_each_info):
        ...
        base_utility.simple_batch.execute(
            'import Project_Farm.farm_chara_checker.main;Project_Farm.farm_chara_checker.main.export_csv();',
            False,
