...
class VertexColorInfo(object):
    ...
    def create_info(self, target_list):
        ...
        for target_transform in self.target_transform_list:
            ...
            new_info_item = VertexColorInfoItem(self, target_transform)
    ...
    def __create_target_vertex_list(self, target_list):
        ...
        for temp_transform in temp_transform_list:
            ...
            if not base_utility.mesh.colorset.get_current(temp_transform):
                continue
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class VertexColorInfoItem(object):
    ...
    def __init__(self, root_info, target_transform):
        ...
        self.vertex_color_info_list = None
        self.fix_vertex_color_info_list = None
    ...
    def _update_info(self):
        ...
        self.fix_vertex_color_info_list = [None] * vertex_count

        for this_info in self.vertex_color_info_list:

            this_vertex_index = this_info[0]

            if self.fix_vertex_color_info_list[this_vertex_index] is None:

                self.fix_vertex_color_info_list[this_vertex_index] = [
                    this_info]

            else:

                self.fix_vertex_color_info_list[this_vertex_index].append(
                    this_info)
        ...
        for target_vertex in self.root_info.target_vertex_list:
            ...
            this_transform = \
                base_utility.mesh.get_transform_from_vertex(
                    target_vertex)
