...
from . import farm_chara_facial_tool_pyside2
...
class GUI(mayaMixin.MayaQWidgetBaseMixin, QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.GEO_OPTION_VAR = 'FarmCharaFacialToolGeoVar'

        self.titleName = 'FarmCharaFacialTool'
        self.ui = farm_chara_facial_tool_pyside2.Ui_MainWindow()
