...
class Main(object):
    ...
    def __init__(self):
        ...
        self.tool_name = 'FarmCharaExporter'
    ...
    def export_current(self):
        ...
        base_utility.simple_batch.execute(
            '{0}{3}{1}{2}'.format(
                'import Project_Farm.farm_chara_exporter.main;',
                'reload(Project_Farm.farm_chara_exporter.main);',
                'Project_Farm.farm_chara_exporter.main.batch_export();',
                import_reload_str
            ),
            True,
