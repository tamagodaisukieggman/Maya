...
from . import material_changer_gui_pyside2
...
class GUI(mayaMixin.MayaQWidgetBaseMixin, QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title_name = 'MaterialChanger'
        self.version = '22033001'
        self.ui = material_changer_gui_pyside2.Ui_MainWindow()
        self.ui.setupUi(self)
        self.setWindowTitle('{} {}'.format(self.title_name, self.version))
