...
def get_pyside_for_maya2013(overwrite=False):
    ...
    if version.find("2013") > -1:
        ...
        if os.path.exists(destination_dir + "\\PySide") == False or overwrite:
            source_dir = "\\\\tkgpublic-fas01\\100_projects\\056_designer_tools\\99_other\\tools\\cygame_designer_tools\\plugin\\PySide"
...
def main():
    ...
    try:
        import Qt_TkgSceneOpener
        reload(Qt_TkgSceneOpener)
        Qt_TkgSceneOpener.main()
    except ImportError:
