...
import time
import re
import TkgMayaRenamerCore as renamer

g_tool_name = "TKGMayaRenamer"
...
class RenamerWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.uiSettingPath = os.path.expanduser("~\\Documents\\maya\\scripts\\tkgpublicMayaRenamerSetting.ini")
        self.createActions()
        self.createMenus()
        # self.resize(500, 285)
    ...
    def showAbout(self):
        QMessageBox.about(self, "About TKG Maya Renamer",
                u"<b>TKG Maya Renamer</b> はMayaのシーンやプロジェクト内のファイルをリネームするツールです。　"
    ...
    def showManual(self):
        import webbrowser
        webbrowser.open(u"https://wisdom.tkgpublic.jp/display/designersmanual/Maya%3A+General"
                        u"#Maya:General-TkgMayaRenamer:一括リネーム")
