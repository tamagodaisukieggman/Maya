...
def export_motion_fbx(out_folder, fbx_name, remove_all,
    ...
    if timing_box:
        ...
        first_split_frame_value = get_first_split_frame()
...
def export_split_animation(out_folder, base_file_name, joints_to_key_rot,
    ...
    num_loop = 0
    num_out = 0
    start_split_frame_value = get_first_split_frame()
    ...
    next_split_frame_value = get_next_split_frame(start_split_frame_value)
    ...
    while True:
        ...
        if next_split_frame_value:
            ...
            # 最後に1フレームだけ別のモーションがる場合は1フレームだけ出力
