...
class ValueSlider(object):
    ...
    # ===============================================
    def __init__(self, label, value, isInteger, **value_edit_param):
        ...
        if value_edit_param:
            value_edit_param['edit'] = True
            self.apply_value_param(**value_edit_param)
    ...
    def get_value(self):
        ...
        return self.apply_value_param(q=True, value=True)

    # ===============================================
    def set_value(self, value):

        self.apply_value_param(e=True, value=value)
    ...
    def apply_value_param(self, **param):
        ...
        if self.isInteger:
            return_value = base_utility.system.exec_maya_command(
                'intSliderGrp', self.ui_value_id, **param)
        else:
            return_value = base_utility.system.exec_maya_command(
                'floatSliderGrp', self.ui_value_id, **param)
