...
def open(target_file_path):
    ...
    try:
        ...
        cmds.file(target_file_path, open=True, force=True, options='v=0;', ignoreVersion=True)
...
def open_temp(
    ...
    try:
        cmds.file(temp_file_path, open=True, force=True, options='v=0;', ignoreVersion=True)
    except:
        pass
...
# ==================================================
def create_temp(target_file_path, temp_file_name=None, temp_dir_path=None):
    """
    一時ファイルを作成
