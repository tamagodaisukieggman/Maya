...
set USR_INPUT_STR_TYPE=bossBattle_mtp
...
set MAIN_HIP_AXIS=No

::set /P ANIM_BASE="アニメーションを流し込むMayaデータを指定してください。:"
::set ANIM_BASE=%ANIM_BASE:\=/%
set ANIM_BASE=Z:/mtk/work/resources/animations/clips/player/workscenes/anm_ply00_m_000_anim.ma
