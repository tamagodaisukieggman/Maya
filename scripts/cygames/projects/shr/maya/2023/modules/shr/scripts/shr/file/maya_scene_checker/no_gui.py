...
MODULE_PATHS = [
                r"C:\Program Files\Autodesk\Maya2023\bin",
                r"C:\Program Files\Autodesk\Maya2023\Python37\lib\site-packages",
                r"C:\cygames\shrdev\shr\tools\tp\lib\pyside\2_py39\site-packages",
                r"C:\cygames\shrdev\shr\tools\in\ext\maya\2023\modules",
                ...
                r"C:\cygames\shrdev\shr\tools\in\ext\maya\2023\modules\shr\scripts",
                r"C:\cygames\shrdev\shr\tools\in\ext\maya\2023\modules\shr\scripts\shr",
                r"C:\cygames\shrdev\shr\tools\in\ext\maya\2023\modules\shr\scripts\shr\file\maya_scene_checker",
                r"C:\cygames\shrdev\shr\tools\tp\ext\maya\share\python\3.9\site-packages",
]
...
class BatchCheck:
    ...
    def set_env(self):
        ...
        os.environ['MTK_MAYA_TOOL_PATH'] = r'{};Z:\mtk\tools\maya\2023'.format(mtk_maya_tool_path)
        os.environ['PRJ_PYTHONPATH'] = prj_pythonpath
        os.environ['PYTHONPATH'] = prj_pythonpath
        # os.environ['MAYA_PLUG_IN_PATH'] = r'Z:\cyllista\tools\maya\modules\anm\plug-ins\2023;{}'.format(maya_plug_in_path)
