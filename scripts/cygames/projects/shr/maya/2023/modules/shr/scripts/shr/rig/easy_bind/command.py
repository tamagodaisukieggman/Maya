...
def query_joint_view()->tuple:
    ...
    Returns:
        tuple: (表示状態:bool, xray表示錠遺体:bool)
    """
...
def change_joint_view(joint_view:bool=True)->None:
    """ジョイントの表示変更

    Args:
        joint_view (bool, optional): _description_. Defaults to True.
    """
    cmds.modelEditor(
                    'modelPanel4',
                    edit=True,
...
def change_joint_xray(joint_xray:bool=False)->None:
    """ジョイントのxray表示変更

    Args:
        joint_xray (bool, optional): _description_. Defaults to False.
    """
    cmds.modelEditor(
                    'modelPanel4',
                    edit=True,
...
def toggle_joint_axis_view(view_state:bool=False)->None:
    """ジョイント軸の表示トグル変更

    Args:
        view_state (bool, optional): _description_. Defaults to False.
    """
