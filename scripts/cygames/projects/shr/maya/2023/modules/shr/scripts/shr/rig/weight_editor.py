...
class WeigtEditor(object):
    ...
    def get_less_threshold_weight_vertex_api2(self, meshes, skin_clusters, select_joints, value):
    ...
    def select_vertex(self, flag, meshes, skin_clusters, _state):
        ...
        if flag == "More":
            if _mod == 4:
                select_vertexs = self.get_less_threshold_weight_vertex_api2(meshes, skin_clusters, select_joints, value)
            else:
    ...
    def update_list(self, vertex, skin_cluster):
        ...
        cmds.rowColumnLayout(self._all_row_colum_layout_name, edit=True,
                                                rowHeight=(1, 14 * weights_length + 12))
