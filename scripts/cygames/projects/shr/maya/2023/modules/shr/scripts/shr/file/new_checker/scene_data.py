...
class ResultData:
    ...
    def __init__(self, category="", error="", error_text="", data_type="", error_nodes=[], error_type_color=[]):
...
class ResultDatas:
    ...
    def set_data(self, category="", error="", error_text="", data_type="", error_nodes=[], error_type_color=[]):
        # 各要素からResultData で要素を追加
        if category:
            _data = ResultData(category, error, error_text, data_type, error_nodes, error_type_color)
