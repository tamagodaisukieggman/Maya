...
def check(data_type_category:str='ENVIRONMENT', scene_path:str='', check_targets:list=[])->scene_data.ResultDatas:
    ...
    for node in check_targets:
        ...
        if i_flag:
            ...
            _result.error_text = "nonManifoldEdges"
            _result.error_nodes = cmds.ls(i_flag, flatten=True)
            _result.error_type_color = [20, 90, 190]
...
def modify(data_type="ENVIRONMENT", scene_path="", error_type_message="", modify_targets=None)->tuple:
    ...
    # else:
    #     try:
    #         cmds.delete(modify_targets)
    #         message = u"Delete [ invalidVertices ] [ {} ]".format(_transform_node)
    #         print("{:-<100}  {}".format(node, "delete invalidVertices"))
    #         success = 1
    #     except Exception as e:
    #         message = u"!! Could Not Delete [ invalidVertices ] [ {} ]".format(_transform_node)
    #         print("{:+<100}  {}".format(node, "delete invalidVertices  error"))
    #         success = 0
