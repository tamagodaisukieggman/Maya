...
try:
    ...
    is_on_maya = True   # TODO: Fix this
except:
    is_on_maya = False  # TODO: Fix this
...
class Plugin(OnCommitProcBase, object):
            ...
            for f in nodes:
                ...
                for path in buf:
                    ...
                    if assetutils.is_non_cached_share_file(path):
                        ...
                        assetutils_maya.MayaUtils.get_instance().set_texture(f, org_texture)
    ...
    def execute(self, args) -> CommitProcessResult:
        ...
        if keep_intermediate:
            if is_on_maya:
                assetutils_maya.write_tempfile('restruct_01', srcfile)
        ...
        if 'override_commit_output' in args['global_args']:
            print('override_commit_output found.')
        ...
        if 'frame_rate' in args:
            ...
            print('Framerate set:', args['frame_rate'])
        ...
        if keep_intermediate:
            if is_on_maya:
                assetutils_maya.write_tempfile('restruct_03', srcfile)

        print('Checking out:', output_fbx_path)
        try:
            p4u.p4_run_xxx('edit', output_fbx_path)
        except:
            print(traceback.format_exc())
        ...
        if is_on_maya:
            ...
            shutil.copyfile(srcfile, output_fbx_path)
