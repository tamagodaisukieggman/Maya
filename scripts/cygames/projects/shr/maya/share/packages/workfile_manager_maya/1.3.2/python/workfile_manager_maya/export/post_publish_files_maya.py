...
def postfunc(presetname=None, inputfile=None, argfile=None):
    ...
    from postproc_set_editor import post_process_operator, ui_preset
    import postproc_set_editor
    from workfile_manager import cmds as wcmds

    print('postfunc: ', __file__, flush=True)
    ...
    for original_work_file in args['target_files'][pid::maxproc]:
        print('original_work_file:', original_work_file, flush=True)
