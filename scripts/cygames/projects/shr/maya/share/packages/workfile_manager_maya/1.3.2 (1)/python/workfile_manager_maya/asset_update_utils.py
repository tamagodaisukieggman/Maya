...
class AssetUpdateUtils():
    ...
    def _proc_db_share(self, filename, asset, _asset, lines, refs_org, refs_new, depth):
        ...
        db.publish(outfile, _asset, '%s [Updated from version:%d]' % (master['comment'], master['version']), username=p4u.user, workfile=None, path_template=_asset.path_template)
        ...
        db.publish_refs(_asset, outfile, refs_new, p4u.user, source_textures=source_textures)
