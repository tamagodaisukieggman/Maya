...
from workfile_manager import p4utils, config
    ...
    def execute(self, presetname=None, inputfile=None, argfile=None):
        ...
        if args['publish_app'] == Application.Maya:
            ...
            if 'submit_server' in args and args['submit_server']:
                db.publish_share_refs(asset, assetdict['asset_id'], outfile, refs, args['user'] if 'user' in args else p4u.user, source_textures=source_textures)
