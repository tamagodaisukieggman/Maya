...
################################################################################
## Form generated from reading UI file 'float4_item.ui'
##
...
class Ui_Item(object):
    def setupUi(self, Item):
        ...
        self.propertyValueFloatW = QDoubleSpinBox(Item)
        self.propertyValueFloatW.setObjectName(u"propertyValueFloatW")
        sizePolicy.setHeightForWidth(self.propertyValueFloatW.sizePolicy().hasHeightForWidth())
        self.propertyValueFloatW.setSizePolicy(sizePolicy)
        self.propertyValueFloatW.setMinimumSize(QSize(0, 0))
        self.propertyValueFloatW.setDecimals(5)
        self.propertyValueFloatW.setMaximum(1000000.000000000000000)

        self.horizontalLayout.addWidget(self.propertyValueFloatW)
