...
def iconViewerUI():
    ...
    log = u'''
2016/07/11 03:12:25 \n
release v0.1.0 : test version
2016/07/13 03:28:17 \n
release v0.2.0 : add search function
2016/07/13 23:58:05 \n
release v0.3.0 : add progress bar
2017/02/09 11:56:55 \n
release v0.4.0 : add UI_run
2018/09/14 22:00:01 \n
release v0.5.0 : copy button
2019/08/09 12:05:14 \n
release v0.6.0 : add help
'''
