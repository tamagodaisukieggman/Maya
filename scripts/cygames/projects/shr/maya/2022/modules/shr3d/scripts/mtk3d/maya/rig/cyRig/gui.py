...
class GUI(MayaQWidgetBaseMixin, QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        for child in self.UI.widget.findChildren(QPushButton):
            ...
            elif child.objectName() == 'changeSpace_refresh_btn':
                continue
            else:
                child.setContextMenuPolicy(Qt.CustomContextMenu)
        ...
        self.UI.spaceAttribute_le.textChanged.connect(self.updateSpaceAttr)
        self.UI.spaceMatchBake_btn.clicked.connect(self.spaceMatchBake)
        self.UI.changeSpace_refresh_btn.clicked.connect(self.updateSpaceAttr)
...
def initBtnStyle_color(obj=None, raiseObj=True):
    ...
    if 'local_c' in obj.objectName():
        obj.setStyleSheet(startBtnStyle_sphere(borderColor=[200, 0, 200]))
    if 'world_c' in obj.objectName():
        obj.setStyleSheet(startBtnStyle_sphere(borderColor=[255, 255, 255]))
    if raiseObj:
        obj.raise_()
...
def changeBtnStyle_color(obj=None):
    ...
    if 'local_c' in obj.objectName():
        obj.setStyleSheet(startBtnStyle_sphere(style='dotted', borderWidth=3, borderColor=[200, 0, 200]))
    if 'world_c' in obj.objectName():
        obj.setStyleSheet(startBtnStyle_sphere(style='dotted', borderWidth=3, borderColor=[255, 255, 255]))
