...
set PYTHONPATH=%PYTHONPATH%;%CURRENT_DIR%;Z:\mtk\tools\maya\modules\mtk3d\scripts\mtk3d\maya\rig\sceneBasedConversion;
...
set COMMAND=import fbxExport;reload(fbxExport);fbxExport.main('%ARGS%','%USR_INPUT_STR%','%NAME_SPACE%')
