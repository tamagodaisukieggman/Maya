...
set PYTHON_EXE="W:\production\tools\python\%PYTHON_VERSION%\python.exe"

set TOOL_ROOT=W:\production\tools

if %SUBMIT_SERVER% == 1 (
    if "%PYTHON_ARCHIVE_DIR%" == "-" (
        set PYTHON_ARCHIVE_DIR=\\cydrive01\100_projects\051_world\document\techartist\tools\python\ver
    ) 

    net use P: \\cydrive01\100_projects\051_world
