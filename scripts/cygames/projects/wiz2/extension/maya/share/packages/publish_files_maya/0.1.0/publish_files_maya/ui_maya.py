...
class MainWindow(mayaMixin.MayaQWidgetBaseMixin, ui.MainWindow):
    ...
    def get_batchfile(self):
        ...
        return 'W:/production/tools/projects/world/inhouse/win/extension/maya/share/packages/workfile_manager_maya/%s/python/workfile_manager_maya/export/post_fbx_export.bat' % wm_maya_ver
