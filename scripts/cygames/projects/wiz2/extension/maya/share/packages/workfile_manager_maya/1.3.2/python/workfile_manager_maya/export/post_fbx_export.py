...
def create_thumbnail(thumb):
    ...
    convcmd = 'c:/cygames/wiz2/tools/cygames/thirdparty/win/standalone/FFmpeg/v4.0.2/bin/ffmpeg.exe -y -i %s.0000.png ' % (thumb_path) + \
...
class Task:
    ...
    def execute(self, presetname=None, inputfile=None, argfile=None):
        ...
        if args['publish_app'] == Application.Maya:
            ...
            cmd = 'python("from workfile_manager_maya.setup_callback_onsave import setup as scs;scs.embed_scene_desc(None)");file -f -save;'
            ...
            if os.path.exists(thumb):
                ...
                if assetdict['task'] == 'animation' and not is_source_on_share(thumb) and ('dont_overlay_icon' not in args or not args['dont_overlay_icon']):
                    play_icon = 'c:/cygames/wiz2/tools/projects/world/inhouse/win/lib/python/share/packages/workfile_manager/%s/workfile_manager/ui/icons/playback.png' % WM_VER
