...
def multiConstraint(src, tgt, t, r, s):
    if t:
        pm.pointConstraint(src, tgt, o=(0,0,0), mo=False, w=1,
                           n='{0}_pointConstraint'.format(tgt))
    if r:
        pm.orientConstraint(src, tgt, o=(0,0,0), mo=False, w=1,
                           n='{0}_orientConstraint'.format(tgt))
    if s:
        pm.scaleConstraint(src, tgt, o=(1,1,1), mo=False, w=1,
                           n='{0}_scaleConstraint'.format(tgt))
