...
UI_FILE = r"Z:\mtk\tools\maya\modules\mtku\scripts\mtku\maya\menus\modeling\lod_create\lod_create.ui"
...
class LODCreateTool(MayaQWidgetBaseMixin, QtWidgets.QMainWindow):
    ...
    def getCurrentHDA(self, hda_name=None):
        ...
        if not hda_name:
            ...
            _current_hda = cmds.ls(hda_name, l=True)
            if _current_hda:
    ...
    def bakeAsset(self, *args):
        ...
        command.bake_asset(self.current_hda, lod_num)
    ...
    def createLod(self, *args):
        ...
        value = self.UI.lodNumSpinBox.value()
        self.lod_num = value
        _current_hda = cmds.rename(_hda, "{}{}".format(root_node[1:], _suffix))
