...
class CameraSequencerShotCursorMoverShotcutRegister(object):
    ...
    def register(cls):
        ...
        cmds.nameCommand(cls.PREVIOUS_CLIP_COMMAND_NAME,
                         ...
                         command='python("import mtk.cutscene.camerasequencer_shot_cursor_mover as mover;mover.CameraSequencerShotCursorMover.previous_key_event()")',
                         default=True)
        cmds.nameCommand(cls.NEXT_CLIP_COMMAND_NAME,
                         annotation=cls.NEXT_CLIP_COMMAND_NAME,
                         command='python("import mtk.cutscene.camerasequencer_shot_cursor_mover as mover;mover.CameraSequencerShotCursorMover.next_key_event()")',
                         default=True)
    ...
    def register(cls):
        ...
        if cmds.draggerContext(cls.context_name, exists=True):
            cmds.draggerContext(cls.context_name,
                                edit=True,
                                pressCommand="import mtk.cutscene.editor.hotkey as hotkey;hotkey.ViewToggleToolContext.press_event()",
                                dragCommand="import mtk.cutscene.editor.hotkey as hotkey;hotkey.ViewToggleToolContext.drag_event()",
                                releaseCommand="import mtk.cutscene.editor.hotkey as hotkey;hotkey.ViewToggleToolContext.release_event()",
                                cursor="dolly",
                                space="screen")
        else:
            cmds.draggerContext(cls.context_name,
        ...
        cmds.nameCommand(cls.press_event_name,
                         ...
                         command='python("import mtk.cutscene.editor.hotkey as hotkey;hotkey.ViewToggleToolContext.press()")',
                         default=True)
        cmds.nameCommand(cls.release_event_name,
                         annotation=cls.release_event_name,
                         command='python("import mtk.cutscene.editor.hotkey as hotkey;hotkey.ViewToggleToolContext.release()")',
                         default=True)
