...
class Menu:
    ...
    def _create_childmenus(self, item: dict) -> None:
        ...
        for child in children:
            ...
            if not type_: continue # typeが入力されて無い場合は無視
    ...
    def reload(self) -> None:
        logger.debug('Reaoad "mtk" modules.')
        importlib.reload(sys.modules['mtk'])
...
def reload_menus():
    cmds.evalDeferred("import mtk.menu;menu.Menu().reload()")