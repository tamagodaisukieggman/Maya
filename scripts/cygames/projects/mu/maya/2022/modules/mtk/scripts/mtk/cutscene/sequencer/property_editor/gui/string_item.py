...
################################################################################
## Form generated from reading UI file 'string_item.ui'
##
...
class Ui_Item(object):
    def setupUi(self, Item):
        ...
        self.propertyValueLine = QLineEdit(Item)
        self.propertyValueLine.setObjectName(u"propertyValueLine")
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.propertyValueLine.sizePolicy().hasHeightForWidth())
        self.propertyValueLine.setSizePolicy(sizePolicy)

        self.horizontalLayout.addWidget(self.propertyValueLine)
    ...
    def retranslateUi(self, Item):
        ...
        self.propertyValueLine.setText(QCoreApplication.translate("Item", u"string,", None))
    # retranslateUi
