...
class HDALoader(object):
    ...
    def create(self):
        ...
        houdini_engine_exists = houdini_util.main()
        if not houdini_engine_exists:
    ...
    def _set_option_var(self):
        cmds.optionVar(iv=[list(self._SessionType.keys())[0],
                           list(self._SessionType.values())[0]])
        cmds.optionVar(iv=[list(self._SessionPipeCustom.keys())[0],
                           list(self._SessionPipeCustom.values())[0]])
        cmds.optionVar(sv=[list(self._ThriftPipe.keys())[0],
                           list(self._ThriftPipe.values())[0]])
