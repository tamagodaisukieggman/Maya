...
class MVNConvertToPly(object):
    ...
    def convert_mvn(self, current_scene=None):
        cmds.file('z:/mtk/work/resources/animations/clips/player/workscenes/anm_ply00_m_000_anim.ma', f=1, o=1)
        destinationFilePath = 'Z:/mtk/tools/maya/modules/mtk3d/scripts/mtk3d/maya/rig/convert/hik/data/characters/ply00_m_000/ply00_m_000_ctrls.json'
        connectFilePath = 'Z:/mtk/tools/maya/modules/mtk3d/scripts/mtk3d/maya/rig/convert/hik/data/characters/ply00_m_000/ply00_m_000_connect_ctrls.json'
        c_mvn = converter.ConvertMVN(destinationFilePath=destinationFilePath, connectFilePath=connectFilePath)
        c_mvn.convert()
        ...
        pv_ctrls = {
                    'HIK_ply00_m_000:lowerarm_L_body_jnt':'ply00_m_000_000:upperarm_L_ik_pv_ctrl',
                    'HIK_ply00_m_000:lowerarm_R_body_jnt':'ply00_m_000_000:upperarm_R_ik_pv_ctrl',
                    'HIK_ply00_m_000:calf_L_body_jnt':'ply00_m_000_000:calf_L_ik_pv_ctrl',
                    'HIK_ply00_m_000:calf_R_body_jnt':'ply00_m_000_000:calf_R_ik_pv_ctrl',
                    }
        ...
        cmds.select(['ply00_m_000_000:CtrlSet', 'ply00_m_000_000:ctrls_sets'], r=1, ne=1)
        ...
        cmds.delete('HIK_ply00_m_000:root_jnt', 'Reference')
        cmds.delete('HIK*')
        cmds.delete(locs)
